...
```sh
sudo curl \
  -L https://raw.githubusercontent.com/nickjj/webserver/v0.4.0/webserver \
...
```sh
docker container run -it -p 127.0.0.1:8008:8008 nickjj/webserver:v0.4.0
```
